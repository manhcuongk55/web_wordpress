<?php
/**
 * Verity Theme Options Sanitization Functions
 *
 * @package Verity
 */
 ...
 */
function verity_sanitize_select( $input, $setting ) {
 ...
 */
function verity_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function verity_sanitize_post( $input ) {
 ...
 * @since Verity 0.2
 */
function verity_sanitize_category_list( $input ) {
    if ( '' != $input ) {
        if( in_array( 0, $input ) ) {
            return '0';
        }
 ...
 *                    the setting default.
 */
function verity_sanitize_number_range( $number, $setting ) {
