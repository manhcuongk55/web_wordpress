...
( function( $ ) {
    ...
    /* Equal Hights */
    $('.hentry .portfolio-entry-header, .hentry .featured-content-entry-header, .testimonial-wrapper .hentry, .archive-post-wrap .entry-container, .footer-meta-area .footer-meta-columns').matchHeight();
    ...
    function initMainNavigation( container ) {
        ...
        var dropdownToggle = $( '<button />', { 'class': 'dropdown-toggle', 'aria-expanded': false })
            .append( verityScreenReaderText.icon )
            .append( $( '<span />', { 'class': 'screen-reader-text', text: verityScreenReaderText.expand }) );
        ...
        container.find( '.dropdown-toggle' ).click( function( e ) {
            ...
            // jscs:enable
            screenReaderSpan.text( screenReaderSpan.text() === verityScreenReaderText.expand ? verityScreenReaderText.collapse : verityScreenReaderText.expand );
        } );
    }
